...
class Game:
    ...
    def pause_menu(self):
        ...
        resume_rect = resume_button.get_rect(center=(self.screen.get_width() // 2, 300))
        options_rect = options_button.get_rect(center=(self.screen.get_width() // 2, 400))
        quit_rect = quit_button.get_rect(center=(self.screen.get_width() // 2, 500))
